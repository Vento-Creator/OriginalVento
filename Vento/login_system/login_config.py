    ...
    def __post_init__(self):
        if self.messages is None:
            self.messages = {
                ...
                "code_not_received": "❓ **Kod kelmadi?**\n\nQuyidagi amallarni sinab ko'ring:\n\n1️⃣ **Telegram iltaimosini tekshiring**\n   • Asosiy Telegram ilovasida xabarni qidiring\n   • 'Xabarlar' bo'limini tekshiring\n\n2️⃣ **Spam qog'ozini tekshiring**\n   • Telegram spam qog'oziga tushgan bo'lishi mumkin\n\n3️⃣ **VPN sinab ko'ring**\n   • Ba'zi hududlarda SMS cheklangan bo'lishi mumkin\n   • VPN orqali urinib ko'ring\n\n4️⃣ **Qo'ng'iroq usulini tanlang**\n   • Pastdagi 'Kodni qayta yuborish' tugmasini bosing\n   • Qo'ng'iroq usuli bilan kod olish mumkin",
