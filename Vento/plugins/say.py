...
from config import is_admin, SAY_COMMAND_ENABLED
...
# /say komandasi config orqali o'chirilgan bo'lsa — handler UMUMAN registratsiya
# qilinmaydi (nol attack surface: /say hech kimga, hech qanday sharoitda javob bermaydi).
# Yoqish uchun: config.json -> "SAY_COMMAND_ENABLED": "true" yoki env SAY_COMMAND_ENABLED=true
if SAY_COMMAND_ENABLED:
