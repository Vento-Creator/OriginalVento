...
async def register_bot_commands():
    ...
    default_commands = [
        ...
        BotCommand("setchallenge", "Yangi guruh maqsadi o'rnatish"),
        BotCommand("xpsettings", "Guruh XP va Level sozlamalari"),
        BotCommand("checkxp", "Foydalanuvchi XP paneli (Bot adminlari)"),
